...
import './RecipeImageInsta.scss';

interface IRecipeImageInstaProps {
    imageUrl : string;
    title : string;
    text : string;
}

const RecipeImageInsta : React.FC<IRecipeImageInstaProps> = props => {
    ...
    return (
        <div className={`recipe-image-insta`} style={{ backgroundImage: `url('${thumbnailUrl}')` }}>
...
export default RecipeImageInsta;